...
4. In the imput field enter this: "https://github.com/JackSParrot/utils-pkg.git"
...
1. Modify your project's `Packages/manifest.json` file adding this line:
    ...
    ```json
    "es.jacksparrot.utils": "https://github.com/JackSParrot/utils-pkg.git"
    ```
